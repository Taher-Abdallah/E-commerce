      ...
      <div class="tab-content pt-2" id="login_register_tab_content">
        <div class="tab-pane fade show active" id="tab-item-register" role="tabpanel" aria-labelledby="register-tab">
          <div class="register-form">
            <form method="POST" action="{{ route('register.store') }}" name="register-form" class="needs-validation" novalidate="">
              @csrf
              <div class="form-floating mb-3">
                <input class="form-control form-control_gray " name="name" value="{{ old('name') }}"  autocomplete="name" 
                  autofocus="">
              ...
              <div class="pb-3"></div>
              <div class="form-floating mb-3">
                <input id="email" type="text" class="form-control form-control_gray " name="email" value="{{ old('email') }}" 
                  autocomplete="email">
              ...
              <div class="form-floating mb-3">
                <input id="password" type="password" class="form-control form-control_gray " name="password" value="{{ old('password') }}"
