            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{ route('front.details', $product->slug) }}"><img loading="lazy" src="{{asset("storage/products/$product->image")}}" width="330"
                          height="400" alt="Cropped Faux leather Jacket" class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                      @foreach(explode(',', $product->images) as $image)
                      <a href="{{ route('front.details', $product->slug) }}"><img loading="lazy" src="{{asset("storage/products/$image")}}"
